...
if ($_GET['d'] == 'index') {
    $mn_dashboard = "active";
} else if ($_GET['d'] == 'master/bu') {
    $mn_master = "menu-open";
    $mn_master1 = "active";
    $mn_masterBu = "active";
} else if ($_GET['d'] == 'master/dept') {
    $mn_master = "menu-open";
    $mn_master1 = "active";
    $mn_masterDept = "active";
    ...
    $mn_MpersonalWallet1 = "active";
    $mn_prefund = "active";
} else if ($_GET['d'] == 'report/paymentByMonthAll') {
    $mn_report = "menu-open";
    $mn_report1 = "active";
    $mn_paymentByMonthAll = "active";
                    ...
                    <?php if ($roleId <= 1) { ?>
                        <li class="nav-item has-treeview <?= $mn_master ?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="index.php?d=master/bu" class="nav-link <?= $mn_masterBu ?>">
                                        <!-- <i class="far fa-circle nav-icon"></i> -->
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <p class="mn_masterBu">Business Unit</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="index.php?d=master/dept" class="nav-link <?= $mn_masterDept ?>">
                                        <!-- <i class="far fa-circle nav-icon"></i> -->
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <p class="mn_masterDept">Department</p>
                                    </a>
                                </li>
