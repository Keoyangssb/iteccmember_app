                    ...
                    <form method="get">
                        ...
                        <div class="box-footer">
                            <button type="reset" class="btn btn-default"
                                onclick="document.location='?d=reportPersonal/balanceByMonth'">ຍົກເລີກ</button>
                                        ...
                                        <table id="example1" class="table table-bordered beautified_report">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($arr as $data) {
                                                    ...
                                                    <?php
                                                    $i++;
                                                    $total = $total + $data['totalBalance'];
                                                } ?>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    <td style="text-align: right;background-color: #17a2b8;color: whitesmoke;font-weight: bold;"
                                                        colspan="9">
                                                        ລວມທັງໝົດ:
                                                    </td>
                                                    <td
                                                        style="background-color: #17a2b8;color: whitesmoke;font-weight: bold;">
